...
describe('RelationPrinter', () => {
  ...
  describe('importing', () => {
    it.each`
      ...
      ${"import { Category } from '../category';"}    | ${ClassType.View}
      ${"import { IDDto } from '@webpackages/core';"} | ${ClassType.CreateDto}
      ${"import { IDDto } from '@webpackages/core';"} | ${ClassType.UpdateDto}
      ${"import { IID } from '@webpackages/common';"} | ${ClassType.ICreateDto}
      ${"import { IID } from '@webpackages/common';"} | ${ClassType.IUpdateDto}
      ${''}                                           | ${ClassType.IEntity}
