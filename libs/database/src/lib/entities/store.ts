 ...
 */
@Entity()
export class ProductCategory extends BaseNameEntity {}

@Exclude()
export class CreateProductCategoryDto extends BaseNameDto {}
 ...
 */
@Entity()
export class ProductDepartment extends BaseNameEntity {}

@Exclude()
export class CreateProductDepartmentDto extends BaseNameDto {}
